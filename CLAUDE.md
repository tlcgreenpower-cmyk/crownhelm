# Tidefall — Lee's personal 3D RTS

Single-file Three.js game: `Tidefall3D.html`. OPEN-WORLD since 2026-07-27 — the tide mechanic
...
(any static server on 8137 works). `index.html` is a deploy MIRROR of `Tidefall3D.html`:
